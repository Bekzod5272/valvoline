...
<template>
  ...
  >
    <div
      class="md:container w-[100%] poco2:w-[90%] flex flex-col sm:flex-row items-center justify-center font-[ValvolineFontMedium]"
    >
      <div class="p-5">
        ...
        <a href="https://t.me/ValvolinePromoBot">
          ...
          >
            {{ props.data.howUseTg.enterTgBot }}
          </button></a
        >
      </div>
      <div>
        <img src="../img/tg-qr.webp" alt="" />
      </div>
    </div>
  </div>
</template>